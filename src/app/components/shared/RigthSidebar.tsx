    ...
    <div className="flex flex-col rounded-xl bg-neutral-900  my-4">
      ...
      <div>
        {Array.from({ length: 5 }).map((_, i) => (
          <div
            key={i}
            className="hover:bg-violet-500/25 p-4 last:rounded-b-xl transition duration-200"
          >
            <div className="font-bold text-lg ">#chatter{i + 1}</div>
    ...
    <div className="flex flex-col rounded-xl bg-neutral-900 my-4">
      ...
      <div>
        {Array.from({ length: 3 }).map((_, i) => (
          <div
            key={i}
            className="hover:bg-violet-500/25 p-4 flex justify-between items-center last:rounded-b-xl transition duration-200"
          >
            ...
            <button className="rounded-full px-6 py-2 bg-violet-700 text-white">
              Follow
            </button>
          </div>
        ))}
